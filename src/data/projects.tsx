...
export const projects: ProjectDemo[] = [
  ...
  { id: 27, title: 'Toast Notification', route: 'toast-notification', finished: true },
  ...
  { id: 51, title: 'Simple Timer', route: 'simple-timer', finished: true },
  { id: 52, title: 'Border Line Animated', route: 'border-line-animated', finished: true },
  {
    id: 53,
    title: 'Adding and Removing Items Animated',
    route: 'adding-and-removing-items-animated',
    finished: true
  }
]
